...
//			System.out.println("Izvrsio se finally");
	...
	private boolean smeSamoprocena() {
		if(klijent.testSamoprocene.getDatum()==null) {// ako je ovo null, znaci da nije do sad radio test samoprocene i da sigurno moze da ga radi
...
//		}
	...
	private void listaSvihKorisnika() {
		String broj =Server.listaRegistrovanih!=null ? String.valueOf(Server.listaRegistrovanih.size()):"0";//Menjao skoro
		izlazniTok.println(broj);
		for (KlijentPodaci k : Server.listaRegistrovanih) {
			izlazniTok.println(k.imeIPrezime);
			izlazniTok.println(k.email);
...
//	private boolean smeBrzi() {
//	GregorianCalendar datumLogina = new GregorianCalendar();
//	GregorianCalendar danPosle = klijent.brziTest.getDatum();
//	// ako je ovo null, znaci da nije do sad radio test samoprocene i da sigurno moze da ga radi
//	if(danPosle==null) {
//		izlazniTok.println("sme");
//		return true;
//	}
